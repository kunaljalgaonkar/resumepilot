/* ===========================================================================
 * Common SVG icons inlined as JS so we don't have to bundle an icon font.
 * Returns SVG strings; call `icon('upload')` from your HTML/JS.
 * ========================================================================= */
export const ICONS = {
  spark: '<svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M128 24l24 80 80 24-80 24-24 80-24-80-80-24 80-24z"/></svg>',
  upload: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>',
  file: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',
  check: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.285 6.708l-11.49 11.49-5.08-5.08 1.414-1.414 3.666 3.666 10.076-10.076z"/></svg>',
  ...
  pencil: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3l4 4-14 14H3v-4z"/></svg>',
  ...
  history: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v5h5M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l4 2"/></svg>',
  ...
  diff: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 9v9M21 12L18 9l-3 3"/><path d="M18 9v8a2 2 0 0 1-2 2h-3"/></svg>',
  ...
  cols: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="18"/><rect x="14" y="3" width="7" height="18"/></svg>',
  ...
  bolt: '<svg viewBox="0 0 24 24" fill="currentColor"><polygon points="13 2 3 14 11 14 11 22 21 10 13 10 13 2"/></svg>',
...
export function icon(name, size = 16, extraClass = "") {
  ...
  return `<span class="ic ${extraClass}" style="display:inline-flex;width:${size}px;height:${size}px;color:currentColor"
    aria-hidden="true">${svg.replace("<svg ", `<svg width="${size}" height="${size}" `)}</span>`;
}
